...
from koopman_model import KoopmanModel, OneStepKoopmanModel, MultiStepKoopmanModel, MultiStepKoopmanModelWithIterative, \
    MultiStepKoopmanModelIterativeV2
...
km = MultiStepKoopmanModelIterativeV2(hidden_dim=hidden_dim,
...
if data == 'fixed':
    ...
    x0 = inf_train_gen(batch_size=batch_size * 100, device=device)  # sample data
