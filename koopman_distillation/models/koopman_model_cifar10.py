...
from koopman_distillation.models.basic_modules import SongUNet
from koopman_distillation.utils.math import psudo_hober_loss, contrastive_loss, generate_gradual_uniform_vector
...
class AdversarialOneStepKoopmanCifar10(torch.nn.Module):
    ...
    def forward(self, x_0, x_T, labels=None):
        ...
        # z_T_gen = self.x_T_observables_encoder(torch.randn_like(x_T) * self.initial_noise_factor, T, labels)
        ...
        # z_0_pushed_gen = self.koopman_operator(z_T_gen.reshape(x_0.shape[0], -1)).reshape(z_0.shape)
        ...
        # x_0_pushed_hat_gen = self.x0_observables_decoder(z_0_pushed_gen, t, labels)
...
class AdversarialOneStepKoopmanCifar10Fast(torch.nn.Module):
    def __init__(self,
                 img_resolution,  # Image resolution at input/output.
                 in_channels=3,  # Number of color channels at input.
                 out_channels=3,  # Number of color channels at output.
        ...
        self.koopman_operator = FastKoopmanMatrix(32 * 32 * out_channels)
        self.psudo_huber_c = psudo_huber_c
